...
class HCLanguagesServiceProvider extends ServiceProvider
{
    /**
     * Register commands
     *
    ...
    public function boot()
    {
        ...
        // loading views
        $this->loadViewsFrom(__DIR__ . '/../../resources/views', 'HCLanguages');

        // loading translations
        $this->loadTranslationsFrom(__DIR__ . '/../../resources/lang', 'HCLanguages');
